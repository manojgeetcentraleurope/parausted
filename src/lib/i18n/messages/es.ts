...
export const esMessages = {
  ...
  redemptions: {
    ...
    amountLabel: 'Importe a canjear (opcional)',
    amountPlaceholder: 'p. ej. 30,00',
    amountHelp: 'Déjalo en blanco para canjear todo el saldo restante.',
    redeemButton: 'Canjear vale',
    redeeming: 'Canjeando...',
    successTitle: 'Vale canjeado',
    successTitlePartial: 'Canje parcial completado',
    ...
    errorInvalidAmount: 'Introduce un importe válido mayor que cero.',
    errorAmountExceedsBalance: 'El importe es mayor que el saldo restante.',
